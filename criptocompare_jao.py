...
URL_HIST_PRICE_MINUTE = 'https://min-api.cryptocompare.com/data/histominute?fsym={}&tsym={}&limit={}&e={}'
...
def get_historical_price_minute(coin, curr=CURR, limit=LIMIT, exchange='CCCAGG'):
    return query_cryptocompare(URL_HIST_PRICE_MINUTE.format(coin, format_parameter(curr), limit , format_parameter(exchange)))
